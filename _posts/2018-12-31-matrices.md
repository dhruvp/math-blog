---
layout: post
title: Relearning Matrices as Linear Functions
comments: false
...
Understanding this helps us perceive some of the key ideas of linear algebra in a new way. In the [next post]({% post_url 2019-02-25-eigenvectors %}), we’re going to focus on eigenvectors and see how they provide valuable insights into these linear maps.
