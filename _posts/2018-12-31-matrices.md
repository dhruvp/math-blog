...
Indeed we can much more write this function as $f(x) = 2x$. This representation, a polynomial, is not only concise, but powerful. How? For example let's say I have another function $g(x) = 10x$, and someone asks, “what happens if I apply $f$, followed by $g$?"
