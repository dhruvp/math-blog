...
If we just multiply $A \cdot FS_{0}$ we compute this dot product get the $FS(Bobby)$ in the first row of the resulting vector.
...
I hope you enjoyed this unique and powerful application of eigenvectors. I haven't yet decided what's going to be in the next post, but stay tuned to find out!
